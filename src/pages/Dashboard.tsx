...
import { Plus, Check, X, CreditCard, ChevronRight, TrendingUp, TrendingDown, Info } from 'lucide-react';
...
export default function Dashboard({ property, setPage }: { property: Property; setPage: (p: Page) => void }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      {/* ── Intestazione immobile — senza badge verde ── */}
      <div style={{ paddingTop: 4 }}>
        ...
        {lastYear && (
          <p style={{ fontSize: 13, color: 'var(--text3)', marginTop: 4 }}>
            Esercizio <strong style={{ color: 'var(--accent)' }}>{lastYear.year_label}</strong>
          </p>
        )}
      </div>
